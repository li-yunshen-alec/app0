...
But we can absolutely promise you meaningful progress if you follow the techniques in this guide.`,
  ...
  },
  {
    ...
    content: [
      {
        isCover: true,
        title: `The power of taking small steps for big results`,
        content: ``,
        image: 'https://media1.tenor.com/m/gIbU3WxDOPUAAAAd/cat-jump-tabby-cat.gif'
      },
      {
        title: '',
        content:
`It may seem obvious that to lose weight, you need to take set goals and take action.

But studies have shown that many people who try to lose weight don't actually set goals.`,
      },
      {
        title: '',
        content:
`This is one of the greatest obstacles to weight loss - studies have shown that when people don't set goals, they tend to avoid taking action.

It's extremely easy to say "I'll start tomorrow" when you never made plans to start today.`,
      },
      {
        title: '',
        content:
`Setting goals means `,
      ...
      {
        title: 'The fallacy of "Thinking big"',
        content:
`You may be inclined to set crazy goals in order to achieve big results.

For example, you might say that you'll never eat ice cream again.`,
        image: 'https://media1.tenor.com/m/IwjS55pNya4AAAAd/cat-licking-an-ice-cream-cat.gif'
      },
      {
        title: 'The fallacy of "Thinking big"',
        content:
`The reality is, crazy goals only lower your chances of success, because they often create a huge gap between what you intend to do and what you actually do.

Would you really be able to never eat ice cream again?`
      },
      {
        title: 'The fallacy of "Thinking big"',
        content:
`Studies show that setting smaller, achievable goals is more effective.

This is because of the principle of positive reinforcement, which states that rewarding behaviours are more likely to be repeated.`
      },
      {
        title: 'The power of achievable goals',
        content:
`As you accomplish small goals in quick succession, the proudness you feel with each accomplishment makes you more likely to repeat the behaviour.

For instance, if your goal is to replace your usual snack with a banana each day, you can start by replacing the snack once every three days.`
      },
      {
        title: 'The power of achievable goals',
        content:
`On Monday, if you eat a banana you can feel proud of yourself. This makes you more likely to do the same in the future.

When you do the same on Thursday, you're further reinforcing the behaviour. This creates the fuel you need to advance further with your goal.

Once you're comfortable with once every three days, you can go to once every two days, and once you're ready, you can completely replace your snack with bananas. 

All because you reinforced your behaviour by accomplishing achievable goals.`
      },
      {
        title: 'A framework for setting effective goals',
        content:
